  ...
  template: `
       <div class="container py-5">
               ...
               <div class="card shadow-sm p-4">
                 ...
                 <form (ngSubmit)="onSubmit()">
                   ...
                   <div class="mb-3">
                     ...
                     <textarea class="form-control" id="message" [(ngModel)]="message" name="message" rows="5" required></textarea>
                   </div>
         ...
         <section class="text-center">
           ...
           <p class="text-muted">
             Email: <a href="mailto:ramzi2020haj@gmail.com" class="text-primary">ramzi2020haj&#64;gmail.com</a><br>
...
export class ContactComponent {
  ...
  onSubmit() {
    // Placeholder pour la logique d'envoi (peut être intégré avec un backend plus tard)
